...
@Component({
  selector: 'kt-laporan-jurnal-rev',
  templateUrl: './laporan-jurnal-rev.component.html',
  styleUrls: ['./laporan-jurnal-rev.component.scss', '../laporan.style.scss']
})
export class LaporanJurnalRevComponent implements OnInit, AfterViewInit {
