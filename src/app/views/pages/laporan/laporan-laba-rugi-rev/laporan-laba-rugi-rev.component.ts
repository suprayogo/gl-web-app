...
@Component({
  selector: 'kt-laba-rugi-rev',
  templateUrl: './laporan-laba-rugi-rev.component.html',
  styleUrls: ['./laporan-laba-rugi-rev.component.scss', '../laporan.style.scss']
})
export class LaporanLabaRugiRevComponent implements OnInit, AfterViewInit {
  // View Child List
  ...
  formInputLyt = [
    ...
    },
    {
      ...
      onSelectFunc: (data) => {
        if (data === '2') {
          this.ekstensiLaporanCbx.splice(2, 1)
