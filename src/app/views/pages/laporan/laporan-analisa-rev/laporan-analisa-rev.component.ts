...
@Component({
  selector: 'kt-laporan-analisa-rev',
  templateUrl: './laporan-analisa-rev.component.html',
  styleUrls: ['./laporan-analisa-rev.component.scss', '../laporan.style.scss']
})
export class LaporanAnalisaRevComponent implements OnInit, AfterViewInit {
  // View Child List
