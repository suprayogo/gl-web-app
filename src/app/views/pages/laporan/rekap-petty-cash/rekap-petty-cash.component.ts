...
const content = {
  beforeCodeTitle: 'Laporan Rekapitulasi Petty Cash'
}

@Component({
  selector: 'kt-rekap-petty-cash',
  templateUrl: './rekap-petty-cash.component.html',
  styleUrls: ['./rekap-petty-cash.component.scss', '../laporan.style.scss']
})
export class RekapPettyCashComponent implements OnInit, AfterViewInit {
  ...
  onSubmitJL(inputForm: NgForm) {
    ...
    if (this.forminput !== undefined) {
      ...
      this.request.apiData('report', 'g-data-rekapitulasi-petty-cash', p).subscribe(
        data => {
          if (data['STATUS'] === 'Y') {
